...
void ESPADFSpeaker::handle_rec_button() {
    if (this->state_ == speaker::STATE_RUUNING || this->state_ == speaker::STATE_STOPPED) {
        this->stop();
